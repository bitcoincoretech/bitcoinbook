...
De asemenea, puteți rula pe testnet3 cu alte implementări de noduri complete, cum ar fi _btcd_ (scris în Go) și _bcoin_ (scris cu JavaScript), pentru a experimenta și a învăța în alte limbaje de programare și framework-uri.
